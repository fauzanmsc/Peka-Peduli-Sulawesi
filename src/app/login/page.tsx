    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Masuk ke Dashboard Admin & Relawan</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="admin@pekapeduli.id"
              />
            </div>
          </div>
      ...
      <div className="absolute bottom-8 text-gray-600 text-xs text-center w-full">
